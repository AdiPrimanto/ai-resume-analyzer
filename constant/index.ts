...
export const prepareInstructions = ({
  ...
  Silakan analisis dan berikan rating pada resume ini serta berikan saran untuk perbaikan.
  Rating bisa rendah jika resume buruk.
  Bersikap teliti dan detail. Jangan ragu untuk menunjukkan kesalahan atau area yang perlu diperbaiki.
